  ...
  return new Promise((resolve, reject) => {
    ...
    SQL(sql, function (data) {
      data.map(item => {
        ...
        item.apartment_facilities = item.apartment_facilities ? JSON.parse(`[${item.apartment_facilities}]`) : ''
        item.supporting_facilities = item.supporting_facilities ? JSON.parse(`[${item.supporting_facilities}]`) : ''
        item.filter_area = item.filter_area ? JSON.parse(`[${item.filter_area}]`) : ''
        item.filter_house = item.filter_house ? JSON.parse(`[${item.filter_house}]`) : ''
        item.filter_price = item.filter_price ? JSON.parse(`[${item.filter_price}]`) : ''
        item.filter_region = item.filter_region ? JSON.parse(`[${item.filter_region}]`) : ''
        item.traffic = item.traffic ? JSON.parse(`[${item.traffic}]`) : ''
